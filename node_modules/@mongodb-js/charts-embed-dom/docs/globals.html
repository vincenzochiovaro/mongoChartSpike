			...
			<table>
				...
				<tbody><tr>
					...
					<tr>
						<td>filter</td>
						<td>object</td>
						<td>A filter to apply to all charts in the embedded dashboard. This expects an object that contains a valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this filter are expected to be added to the allowed fields list for filtering in the &#39;Embed Dashboard&#39; dialog.</td>
					</tr>
					<tr>
						<td>charts</td>
						<td>array of objects</td>
						<td>Embedding options to apply to specified embedded dashboard charts. Currently, we only support filters. An example is <code>[ { chartId: &#39;0b1e7577-5ad6-4be4-8b13-5b0bee7d291f&#39;, filter: { city: &#39;Sydney&#39; }}]</code> where chartId is the embedding chart id of the dashboard chart, and filter is an MQL expression for what you want to filter this chart&#39;s data by.</td>
					</tr>
			</tbody></table>
			<hr>
