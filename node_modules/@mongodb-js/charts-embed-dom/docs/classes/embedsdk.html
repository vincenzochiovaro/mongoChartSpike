...
<head>
	...
	<title>EmbedSDK | @mongodb-js/charts-embed-dom</title>
		...
		<li class="current tsd-kind-class">
			...
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class">
					<a href="embedsdk.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="embedsdk.html#createchart" class="tsd-kind-icon">create<wbr>Chart</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="embedsdk.html#createdashboard" class="tsd-kind-icon">create<wbr>Dashboard</a>
				</li>
			</ul>
		</li>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Creates an instance of the embedding SDK</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">EmbedSDK</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class"><a href="embedsdk.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="embedsdk.html#createchart" class="tsd-kind-icon">create<wbr>Chart</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="embedsdk.html#createdashboard" class="tsd-kind-icon">create<wbr>Dashboard</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">new <wbr>EmbedSDK<span class="tsd-signature-symbol">(</span>options<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Partial</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">EmbedOptions</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="embedsdk.html" class="tsd-signature-type">EmbedSDK</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Accepts an optional <a href="../interfaces/embedchartoptions.html">EmbedChartOptions</a> object to use as the
								default options for any charts created using this SDK instance.</p>
							</div>
							<pre><code class="language-js"><span class="hljs-keyword">const</span> sdk = <span class="hljs-keyword">new</span> EmbedSDK({
  <span class="hljs-attr">baseUrl</span>: <span class="hljs-string">"https://charts.mongodb.com"</span>,
})</code></pre>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>options: <span class="tsd-signature-type">Partial</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">EmbedOptions</span><span class="tsd-signature-symbol">&gt;</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="embedsdk.html" class="tsd-signature-type">EmbedSDK</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="createchart" class="tsd-anchor"></a>
				<h3>create<wbr>Chart</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">create<wbr>Chart<span class="tsd-signature-symbol">(</span>options<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Partial</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/embedchartoptions.html" class="tsd-signature-type">EmbedChartOptions</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="chart.html" class="tsd-signature-type">Chart</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Creates a new <a href="chart.html">Chart</a> instance that allows you to
								interact with and embed charts into your application</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>options: <span class="tsd-signature-type">Partial</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/embedchartoptions.html" class="tsd-signature-type">EmbedChartOptions</a><span class="tsd-signature-symbol">&gt;</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="chart.html" class="tsd-signature-type">Chart</a></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="createdashboard" class="tsd-anchor"></a>
				<h3>create<wbr>Dashboard</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">create<wbr>Dashboard<span class="tsd-signature-symbol">(</span>options<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Partial</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/embeddashboardoptions.html" class="tsd-signature-type">EmbedDashboardOptions</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="dashboard.html" class="tsd-signature-type">Dashboard</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Creates a new <a href="dashboard.html">Dashboard</a> instance that allows you
								to embed a dashboard into your application</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>options: <span class="tsd-signature-type">Partial</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/embeddashboardoptions.html" class="tsd-signature-type">EmbedDashboardOptions</a><span class="tsd-signature-symbol">&gt;</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="dashboard.html" class="tsd-signature-type">Dashboard</a></h4>
					</li>
				</ul>
			</section>
		</section>
